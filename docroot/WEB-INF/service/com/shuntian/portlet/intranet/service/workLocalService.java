...
/**
 * Provides the local service interface for work. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see workLocalServiceUtil
...
public interface workLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link workLocalServiceUtil} to access the work local service. Add custom service methods to {@link com.shuntian.portlet.intranet.service.impl.workLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
