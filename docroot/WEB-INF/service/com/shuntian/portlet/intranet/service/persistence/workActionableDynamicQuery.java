 ...
 * @generated
 */
public abstract class workActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public workActionableDynamicQuery() throws SystemException {
		setBaseLocalService(workLocalServiceUtil.getService());
		setClass(work.class);

		setClassLoader(com.shuntian.portlet.intranet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("workId");
	}
}