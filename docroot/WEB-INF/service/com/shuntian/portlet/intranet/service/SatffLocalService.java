...
/**
 * Provides the local service interface for Satff. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SatffLocalServiceUtil
...
public interface SatffLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SatffLocalServiceUtil} to access the satff local service. Add custom service methods to {@link com.shuntian.portlet.intranet.service.impl.SatffLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
